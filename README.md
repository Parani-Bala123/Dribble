            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="card shot-card shadow-sm">
                        <img src="rafiz.png" class="shot-image" alt="Design shot">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <img src="rafiz logo.jpg" class="user-avatar me-2" alt="User">
                                <div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card shot-card shadow-sm">
                        <img src="three dee.jpeg" class="shot-image" alt="Illustration">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <img src="three dee logo.jpg" class="user-avatar me-2" alt="User">
                                <div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card shot-card shadow-sm">
                        <img src="nixito.jpg" class="shot-image" alt="Branding">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <img src="nixito logo.png" class="user-avatar me-2" alt="User">
                                <div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card shot-card shadow-sm">
                        <img src="zko.jpg" class="shot-image" alt="Branding">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <img src="zko logo.jpg" class="user-avatar me-2" alt="User">
                                <div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card shot-card shadow-sm">
                        <img src="saveit.jpg" class="shot-image" alt="Mobile App">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <img src="show it.png" class="user-avatar me-2" alt="User">
                                <div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-md-end">
                    <p class="mb-0">Created by <strong>PARANI BALA M</strong></p>
                </div>
            </div>
        </div>
    </footer>
